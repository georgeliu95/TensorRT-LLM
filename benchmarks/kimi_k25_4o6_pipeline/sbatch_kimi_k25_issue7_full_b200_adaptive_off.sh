...
#SBATCH --job-name=llm4o6-kimi-issue7-full-b200-adaptive-off
...
OUT_ROOT="${OUT_ROOT:-${ROOT}/benchmarks/kimi_k25_issue7_full_b200_adaptive_off_${SLURM_JOB_ID:-manual}_${RUN_STAMP}}"

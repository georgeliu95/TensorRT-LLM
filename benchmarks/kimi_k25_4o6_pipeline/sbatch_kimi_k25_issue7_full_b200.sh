...
#SBATCH --job-name=llm4o6-kimi-issue7-full-b200
...
#SBATCH --output=/home/scratch.georgel_gpu/projects/llm_4o6/benchmarks/sbatch_kimi_k25_issue7_full_b200_%j.out
...
OUT_ROOT="${OUT_ROOT:-${ROOT}/benchmarks/kimi_k25_issue7_full_b200_${SLURM_JOB_ID:-manual}_${RUN_STAMP}}"

...
#SBATCH --job-name=llm4o6-kimi-issue7-full-b200-adaptive-off-node069
#SBATCH --partition=b200@500-1000W/umbriel-b200@ts4/8gpu-224cpu-2048gb
#SBATCH --account=all-users
#SBATCH --qos=batch-short
#SBATCH --nodes=1
#SBATCH --gres=gpu:8
#SBATCH --nodelist=umbriel-b200-069
#SBATCH --time=04:00:00
#SBATCH --output=/home/scratch.georgel_gpu/projects/llm_4o6/benchmarks/sbatch_kimi_k25_issue7_full_b200_adaptive_off_node069_%j.out
...
OUT_ROOT="${OUT_ROOT:-${ROOT}/benchmarks/kimi_k25_issue7_full_b200_adaptive_off_node069_${SLURM_JOB_ID:-manual}_${RUN_STAMP}}"
...
TRTLLM_4O6_LOAD_TIMING_RANKS=0 \

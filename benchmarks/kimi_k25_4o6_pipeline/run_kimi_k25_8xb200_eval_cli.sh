...
TRTLLM_4O6_FORCE_LAZY="${TRTLLM_4O6_FORCE_LAZY:-1}"
TRTLLM_4O6_LAZY_PREFETCH="${TRTLLM_4O6_LAZY_PREFETCH:-1}"
TRTLLM_4O6_LAZY_PREFETCH_WORKERS="${TRTLLM_4O6_LAZY_PREFETCH_WORKERS:-4}"
TRTLLM_4O6_LAZY_PREFETCH_ORDER="${TRTLLM_4O6_LAZY_PREFETCH_ORDER:-demand}"
TRTLLM_4O6_LAZY_PREFETCH_WAIT_FOR_TENSOR="${TRTLLM_4O6_LAZY_PREFETCH_WAIT_FOR_TENSOR:-0}"
...
docker run --rm --runtime=nvidia \
    ...
    -e TRTLLM_4O6_FORCE_LAZY="${TRTLLM_4O6_FORCE_LAZY}" \
    -e TRTLLM_4O6_LAZY_PREFETCH="${TRTLLM_4O6_LAZY_PREFETCH}" \
    -e TRTLLM_4O6_LAZY_PREFETCH_WORKERS="${TRTLLM_4O6_LAZY_PREFETCH_WORKERS}" \
    -e TRTLLM_4O6_LAZY_PREFETCH_ORDER="${TRTLLM_4O6_LAZY_PREFETCH_ORDER}" \
    -e TRTLLM_4O6_LAZY_PREFETCH_WAIT_FOR_TENSOR="${TRTLLM_4O6_LAZY_PREFETCH_WAIT_FOR_TENSOR}" \
...
for module_name in (
    ...
    print('MODULE_ORIGIN ' + module_name + '=' + (spec.origin if spec else 'None'), flush=True)
PY
...
echo TRTLLM_4O6_FORCE_LAZY='${TRTLLM_4O6_FORCE_LAZY}'
echo TRTLLM_4O6_LAZY_PREFETCH='${TRTLLM_4O6_LAZY_PREFETCH}'
echo TRTLLM_4O6_LAZY_PREFETCH_WORKERS='${TRTLLM_4O6_LAZY_PREFETCH_WORKERS}'
echo TRTLLM_4O6_LAZY_PREFETCH_ORDER='${TRTLLM_4O6_LAZY_PREFETCH_ORDER}'
echo TRTLLM_4O6_LAZY_PREFETCH_WAIT_FOR_TENSOR='${TRTLLM_4O6_LAZY_PREFETCH_WAIT_FOR_TENSOR}'

...
from tensorrt_llm.models import CogVideoXTransformer3DModel
...
def convert_and_save_hf(args):
    ...
    def convert_and_save_rank(args, rank):
        ...
        tik = time.time()
        cogvideox.save_checkpoint(args.output_dir, save_config=(rank == 0))
        ...
        config["use_pretrained_pos_emb"] = True if "pos_embed.pos_embed" in [
            name for name, _ in cogvideox.named_parameters()
        ] else False

    ...
    def test_qwen3_moe_nvfp4_mapper_normalizes_checkpoint_scales(self):
        ...
        mapper.handle_special_instance_module(
            ...
            "model.layers.0.mlp.experts",
            {
                ...
                "0.gate_proj.input_scale": input_scale,
                "0.gate_proj.weight_scale_2": weight_scale_2,
        ...
        self.assertIs(loaded["0.w1.input_scale"], input_scale)
        self.assertIs(loaded["0.w1.weight_scale_2"], weight_scale_2)

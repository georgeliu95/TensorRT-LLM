            ...
            if use_fc31:
                ...
                requantized, weight_scale_2 = (
                    _adaptive_4o6_requantize_nvfp4_group(
                        entries, scale_rule))
                # Pre-quantized NVFP4 checkpoints already carry the FC31
                # global reciprocal scale used by TRT-LLM's alpha path. The
                # requantized local block scales must be interpreted under
                # that original scalar; replacing it breaks Qwen FC31 output.
                weight_scale_2 = entries[0][2]
                ...
                if dense_source:
                    ...
                    requantized, weight_scale_2 = (
                        _adaptive_4o6_requantize_nvfp4_group(
                            ...
                            scale_rule))
                    # Keep FC31's checkpoint-level global reciprocal scale;
                    # only the packed weights and block scales are re-encoded.

...
class CuteDslFusedMoE(CutlassFusedMoE):
    ...
    def run_moe_nvfp4(
        ...
        if _use_adaptive_fc2:
            return self.run_moe_nvfp4_impl(
                ...
                moe_output, weight_view, enable_alltoall=enable_alltoall, tile_size=128)
    ...
    def run_moe_nvfp4_impl(
        ...
        fc1_alpha = weight_view.fc1_global_scale[0]
        ...
        if _use_adaptive_fc2:
            ...
            fc2_alpha = weight_view.fc2_global_scale[0] * correction
